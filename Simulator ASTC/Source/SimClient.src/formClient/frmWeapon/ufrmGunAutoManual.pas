...
begin
  ...
  begin
    AddStatus('Weapon belum terdefisikan');
    exit;
  end;
...
begin
  ...
  if not Assigned(tgt) then
  begin
    AddStatus('Tentukan target terlebih dahulu');
  ...
  begin
    AddStatus('Senjata yang digunakan tidak sesuai dengan target');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          AddStatus('Tidak bisa melakukan penembakan');
        end;
      end;
    end;
  end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AddStatus('Target tidak bisa ditembak');
          Exit;
        end;
      end;
    end;
...
//    simMgrClient.FlashPointNGS.PosY := TT3GunOnVehicle(FWeapon).NGSFlashY;
  ...
  case TT3GunOnVehicle(FWeapon).ControlMode of
    ...
    begin;
      ...
      begin
        //raise Exception.Create('Target not selected yet')
        AddStatus('Target belum terpilih');
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          AddStatus('Posisi Bloom melebihi batas maksimum : '
        ...
        begin
          AddStatus('Posisi Bloom Altitude melebihi batas maksimum : '
        ...
        begin
          AddStatus('Chaff berada di blindzone'); //mk
          exit;
        end;
...
begin
  ...
  if (not Assigned(ve)) then
  begin
    AddStatus('Controlled platform bukan termasuk vehicle'); //mk
    Exit;
  end;
...
begin
  ...
  begin
    ...
    begin
      if (not Assigned(FWeapon)) or (not(FWeapon is TT3GunOnVehicle)) then
      begin
        AddStatus('Weapon beum terdefinisikan'); //mk
        exit;
      end;
...
begin
  ...
  begin
    AddStatus('Targeted platform belum terdefinisikan');
    exit;
  end;
  ...
  begin
    ...
    AddStatus('Targeted Platform must be set on');
    exit;
  end
  else
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          AddStatus('Targeted Platform adalah FreeMe');
          exit;
        end
        else
        begin
          ...
          begin
            AddStatus('Senjata tidak sesuai dengan target');
            exit;
          end;
    ...
    begin
      ...
      AddStatus('Own platform tidak dapat ditargetkan');
      exit;
    end;
  end;
