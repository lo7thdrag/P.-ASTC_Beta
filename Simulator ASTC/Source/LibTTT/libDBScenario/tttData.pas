...
/// symbol pictures name
  ...
  /// Bomb Type
  btBomb = 0; btsBomb = 'Bomb';
  btDepthCharge = 1; btsDepthCharge = 'Depth Charge';
  btRocket = 2; btsRocket = 'Rocket Bomb';

  {Prince}
  //Strategi
  stBaseAD = 0;     stsBaseAD = 'Base AD';
  stBaseAL = 1;     stsBaseAL = 'Base AL';
  stBaseAU = 2;     stsBaseAU = 'Base AU';
  stBasePOLRI = 3;  stsBasePOLRI = 'Base POLRI';
  stBaseRadar = 4;  stsBaseRadar = 'Base Radar';
...
//  mcPressure = 3;
  ...
  //formation type
  fColumn     = 1;    fColumns      = 'Column';
  fStagColumn = 2;    fStagColumns  = 'Stag Column';
  fWedge      = 3;    fWedges       = 'Wedge';
  fEchLeft    = 4;    fEchLefts     = 'Ech Left';
  fEchRight   = 5;    fEchRights    = 'Ech Right';
  fVee        = 6;    fVees         = 'Vee';
  fLine       = 7;    fLines        = 'Line';
  fFile       = 8;    fFiles        = 'File';
  fDiamond    = 9;    fDiamonds     = 'Diamond';
  ...
  { for goto time }
  C_GotoTimeInfo : array [0..4] of String =
    ( '5 Minutes', '30 Minutes', '1 Hour', '2 Hour', '1 Day');
...
type
  ...
  TWeaponStatus = ( wsAvailable, wsUnavailable, wsDamaged, wsTooHigh, wsFiring );
  ...
  E_WaypointStartTimeMode = (wstmNow, wstmStartAt);
  ...
  TOnWeaponHitTo3D    = procedure (aWeapon : TObject; aTrack : TObject; aValue : Double) of object;
  ...
  TOnMissileSynchVBS = procedure (aWeapon : TObject) of object;
  ...
  //event send data speed
  TEventSendPlatformcmd = procedure (const pi_id: integer;
    const ordID, ordType, DiveMode: Byte; const cmdParam: single) of object;
  ...
  ///  wtSp : Stop platform on last waypoint
  TWaypointTermination = (wtLH, wtTH, wtRP,wtRP2, wtRB, wtRM, wtSp);
  ...
  TOnNextWaypointChangeTo3D = procedure (WaypointID, aShipID: Integer;
    aSpeed, aBearing, Altitude, PosX, PosY: Double) of object; //choco
  /// Record for waypoint
  ///
  TRecWaypoint = record
    Name   : string[20];
  ...
  TVehicleGuidanceType = ( vgtNone,
                           ...
                           vgtReturnToBase, vgtPersonelGuidance );
  ...
  TOnCollision = procedure(Sender, Target : TObject; Value : Boolean) of object;
  TOnFuelEmpty = procedure(Sender : TObject; OrderType: Byte; Value : Double) of object;

  TOnChangeHeading = procedure(Sender : TObject; OrderType: Byte; Value : Double) of object;
  TOnChangePosition = procedure(Sender : TObject; IdAction: Byte; x, y: Double) of object;
  TOnChangeSpeed = procedure(Sender : TObject; Value : Double) of object;

  TTransportedStatus = (tsQueue, tsEmbarkProcess, tsStandby, tsReady);
  TOrbatLevel = (olBrigade, olBatalyon, olKompi, olPlatoon, olGroup);
...
////====================================================
  ...
  TRecLogistic_Characteristics =  record
    Logistics_Index : integer;
    Logistics_Identifier : string[60];
    ...
    Max_Lubricants_Capacity : double;
    Max_Freshwater_Capacity : double;
    Max_Water_Capacity : double;
    Max_Ration_Capacity  : double;

    Lubricants_Consumption : double;
    Freshwater_Consumption : double;
    Water_Consumption : double;
    Ration_Consumption : double;

    Fuel_TrS : Double;
    Lubricant_TrS : Double;
    Freshwater_TrS : Double;
    Water_TrS : Double;
    Ration_TrS : Double;
...
////====================================================
  ...
  TRecPlotting_Definition = record
    ...
    Plotting_Name : string[50];
    Plotting_Type : Integer;
    Plotting_Group : Integer;
  end;
  TRecResource_Plotting_mapping = record
    Resource_Alloc_Index : integer;
    Plotting_Index : integer;
...
//    Template_Form        : string[2000];
  ...
  TRecVehicle_Definition =  record
    ...
    Logistic_Characteristics           : integer;
    Capability_Characteristics         : integer;
    Length                             : single;
    Width                              : single;
    Height                             : single;
    Draft                              : single;
...
//    MainBodyDamage  : boolean; /// begin to sink..
 ...
 TRecGameReport = record
  ...
  ////====================================================
  TRecPlatform_Embark_Library = record
    Platform_Embark_Index : integer;
    Vehicle_Identifier    : string[60];
  ...
  TRecTransport = record
    ...
    Transport_Identifier    : string[60];
    Carriable               : Boolean;
    Hangar_Unit_Carried     : Boolean;
    Deck_Unit_Carried       : Boolean;
    Personnel_Unit_Carried  : Boolean;
    FixedWing_Carried       : Boolean;
    Rotary_Carried          : Boolean;
    Amphibious_Carried      : Boolean;
    Land_Carried            : Boolean;
