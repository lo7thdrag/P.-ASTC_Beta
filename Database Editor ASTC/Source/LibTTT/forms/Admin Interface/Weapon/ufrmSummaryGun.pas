...
uses
  uDataModuleTTT, ufrmGunPOHGraphic, uSession;
...
function TfrmSummaryGun.SetWeaponCategory(iValue: integer): string;
begin
  case iValue of
...
procedure TfrmSummaryGun.edtClassChange(Sender: TObject);
begin
  btnApply.Enabled := True;
end;
