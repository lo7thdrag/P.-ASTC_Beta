...
interface
 ...
 uses  Controls, Classes,tttData,uDBScenario,sysutils,
  uDBFormation,uDBAsset_GameEnvironment,uDBGame_Defaults,uT3SimManager,uDBAsset_Weapon,
  newClassASTT, uDBAssetObject, uDBAsset_Satellite, uDBAsset_MotionCharacteristics,
  uDBAsset_Radar, uDBAsset_Sensor, uDBAsset_Sonobuoy, uDBAsset_Sonar, uDBAsset_Vehicle, uDBNote_Storage, uPelabuhan;//,uDBStudentRole;
 ...
 procedure deleteAllFormation_Assignment(form_id: string);
 ...
 procedure updateSatellite_Def(var rec: TSatellite_Definition;const id: string);
...
uLibSettingTTT,uDataModuleTTT,ufDBSetting, uDBAssets_SubAreaEnviroDefinition, uDBEditSetting,ufrmAvailableScenario;
...
procedure getDefaults(var sclist:Tlist;var rec:TGame_Defaults);
begin
  dmTTT.GetAllGame_Defaults(0,sclist);
end;
...
procedure deleteAllFormation_Assignment(form_id: string);
begin
  dmTTT.deleteAllFormation_Assign(form_id);
end;
