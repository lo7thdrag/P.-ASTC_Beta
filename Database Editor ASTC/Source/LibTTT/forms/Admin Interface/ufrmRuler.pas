...
//begin
//  ufrmOverlayEditor.Map1.CurrentTool := mtSelectObject;
...
begin
  ...
  frmWaypointEditor.Map1.Repaint;
  OverlayEditorForm.Map1.Repaint;

  OverlayEditorForm.ClearFlagPoint;
end;

procedure TfrmRuler.FormHide(Sender: TObject);
begin
isshow:=false  ;
case IDForm of
{$REGION 'waypoint'}
...
begin
     frmWaypointEditor.Map1.Repaint;
     frmWaypointEditor.btnruler.ImageIndex:=13;
//   frmWaypointEditor.ClearFlagPoint;
...
begin
        OverlayEditorForm.Map1.Repaint  ;
   OverlayEditorForm.ClearFlagPoint;
           OverlayEditorForm.btnruler.ImageIndex:=14;
end;

end;
     edtRulerStartPosLong.Clear;
   edtRulerEndPosLong.Clear;
   edtRulerStartPosLat.Clear;
   edtRulerEndPosLat.Clear;


//   OverlayEditorForm.edtLineStartPosLat.Clear;
//   OverlayEditorForm.ClearEditText;
end;
