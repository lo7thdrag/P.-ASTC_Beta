...
uses
  uDataModuleTTT, uProbabilityGraph, ufrmMinePODGraphic, uSession;
...
procedure TfrmSummaryMine.FormCreate(Sender: TObject);
begin
...
procedure TfrmSummaryMine.btnUploadClick(Sender: TObject);
var
