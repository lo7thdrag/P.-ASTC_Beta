...
uses
  uDataModuleTTT, ufrmSNRvsPODPickList, ufrmRadarCoverageGraphic, uSession;
...
begin
  ...
  begin
    ...
    trckbrPercentageMaxUnambigous.Position :=
      Round(FDef.Max_Unambig_Detect_Range);
